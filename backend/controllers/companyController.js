...
<head>
  ...
  <style>
    ...
    .cr-hdr-sub { font-size: 10px; color: #F5A623; letter-spacing: 0.8px; text-transform: uppercase; font-weight: 600; margin: 0; }
    .cr-badge { background: #F5A623; color: #1a1d2e; font-size: 10px; font-weight: 700; letter-spacing: 0.8px; text-transform: uppercase; padding: 4px 11px; border-radius: 2px; white-space: nowrap; }
    .cr-divider { height: 3px; background: #F5A623; }
    ...
    .cr-section-head span { font-size: 10px; font-weight: 700; color: #F5A623; letter-spacing: 1px; text-transform: uppercase; }
