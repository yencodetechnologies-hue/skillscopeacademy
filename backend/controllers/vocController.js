...
<head>
  ...
  <style>
    ...
    .eb-hdr-sub { margin: 6px 0 0; font-size: 11px; color: #cc0000; letter-spacing: 0.8px; text-transform: uppercase; font-weight: 600; }
    .eb-divider { height: 3px; background: #cc0000; }
