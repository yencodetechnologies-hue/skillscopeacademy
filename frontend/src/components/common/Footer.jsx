...
function Footer() {
  ...
  const courseList    = courseTitles.length    ? courseTitles
                      : footer?.courses?.length ? footer.courses
                      : mockFooter.courses
  // Normalize quickLinks — CMS may return strings, mockData returns objects
  const rawQuickLinks  = footer?.quickLinks?.length ? footer.quickLinks : mockFooter.quickLinks
