...
<head>
  ...
  <style>
    ...
    .eb-step-text a { color: #F57C00; text-decoration: none; font-weight: 700; }

    /* ── Checklist ── */
    .eb-check-item { margin-bottom: 8px; font-size: 13px; color: #475569; }
    .eb-check-icon { color: #F57C00; margin-right: 10px; font-weight: bold; font-size: 16px; }
        ...
        <tr>
          ...
          <td align="right" valign="top">
            <div style="display:inline-block; text-align:right; min-width: 200px;">
              <span class="eb-badge" style="background:#F57C00; color:#1a1d2e; font-size:16px; font-weight:800; letter-spacing:1px; text-transform:uppercase; padding:6px 0; border-radius:3px; display:block; text-align:center; line-height:1; margin-bottom:8px;">Confirmed</span>
