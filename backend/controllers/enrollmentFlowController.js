...
// <tr><td style="background:#0d2240;color:#ffffff;padding:24px 30px;text-align:center;border-bottom:4px solid #cc0000;">
  ...
  try {
    ...
    res.json({
      ...
      stats: [
        { label: "Pending Verification", value: stats.pending, color: "#f39c12" },
        { label: "Verified Payments", value: stats.success, color: "#27ae60" },
        { label: "Total Verified Amount", value: `$${stats.totalAmount}`, color: "#cc0000" }
      ]
    });
