...
const commonStyles = `
    ...
    .eb-hdr-sub { font-size: 10px; color: #F57C00; letter-spacing: 0.8px; text-transform: uppercase; font-weight: 600; margin: 0; }
    .eb-badge-sky { background: #F57C00; color: #1a1d2e; font-size: 10px; font-weight: 700; letter-spacing: 0.8px; text-transform: uppercase; padding: 3px 10px; border-radius: 2px; display: inline-block; line-height: 1; }
...
<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8" /><style>${commonStyles}</style></head><body><div class="eb-body">
    <div class="eb-hdr">
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
            <tr>
                <td><p class="eb-hdr-title">Safeticks</p><p class="eb-hdr-sub"> &nbsp;·&nbsp; ADMIN NOTIFICATION</p></td>
    ...
    <div class="eb-footer">This is an automated admin notification from <strong>Safeticks</strong> ().<br/>15/3 Lancaster Street Ingleburn NSW 2565 &nbsp;·&nbsp; 1300 976 097 &nbsp;·&nbsp; info@safetytrainingacademy.edu.au</div>
</div></body></html>`;
};
...
<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8" /><style>${commonStyles}</style></head><body><div class="eb-body">
    <div class="eb-hdr">
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
            <tr>
                <td><p class="eb-hdr-title">Safeticks</p><p class="eb-hdr-sub"> &nbsp;·&nbsp; BOOKING CONFIRMATION</p></td>
    ...
    <div class="eb-content">
        ...
        <p style="color: #475569; font-size: 14px; margin: 0 0 24px; line-height: 1.5;">Thank you for booking with Safeticks. Your booking is confirmed — please review the details below and make sure all pre-course steps are completed before your training date.</p>
    ...
    <div class="eb-footer">
        Questions? <a href="mailto:admin@safetytrainingacademy.com.au" style="color:#F57C00; text-decoration:none;">admin@safetytrainingacademy.com.au</a> | 1300 976 097<br/>
        <strong>Safeticks</strong> |  | <a href="https://www.safetytrainingacademy.edu.au" style="color:#F57C00; text-decoration:none;">Student Portal</a><br/><br/>
  ...
  return `
    <div class="eb-hdr" style="background:#0d2240; padding:24px 30px;">
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td valign="top">
            <p class="eb-hdr-title" style="font-size:18px; font-weight:700; color:#ffffff; margin:0;">Safeticks</p>
            <p class="eb-hdr-sub" style="font-size:10px; color:#F57C00; letter-spacing:0.8px; text-transform:uppercase; font-weight:600; margin:4px 0 0;"> &nbsp;·&nbsp; ${subTitle}</p>
          </td>
          <td align="right" valign="top">
            <div style="display:inline-block; text-align:right; min-width: 200px;">
              <div class="eb-badge-sky" style="background:#F57C00; color:#1a1d2e; font-size:16px; font-weight:800; letter-spacing:1px; text-transform:uppercase; padding:6px 0; border-radius:3px; display:block; text-align:center; line-height:1; margin-bottom:8px;">${badgeText}</div>
    ...
    ${isAdmin ? `<div class="eb-confirm-banner" style="background:#0a1c33; padding:10px 24px; font-size:12px; color:#89c8e8; font-weight:700; text-align:center; border-bottom:3px solid #F57C00;">Action Required</div>` : ''}
  `;
};
...
const sendCompanyOrderConfirmation = async (req, res) => {
    ...
    const linksHtml = links.map(l => `
        <tr><td style="padding:15px; border-bottom:1px solid #f1f5f9; background:#ffffff;">
            ...
            <p style="margin:6px 0 0; font-size:12px;"><a href="${l.fullUrl}" style="color:#F57C00; text-decoration:none; font-weight:600;">Click to Register &rarr;</a></p>
