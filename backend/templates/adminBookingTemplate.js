const adminBookingTemplate = (data) => {
  ...
  const gatewayRow = gatewayIdValue !== '-' ? `
    <tr>
      ...
      <td class="val" style="color: #F5A623;"><strong>${gatewayIdValue}</strong></td>
    </tr>` : '';
...
<head>
  ...
  <style>
    ...
    .eb-table td a { color: #F5A623; text-decoration: none; }

    /* ── Total row ── */
    .eb-total-row td { background: #f0f6ff !important; border-top: 2px solid #F5A623; }
        ...
        <tr>
          ...
          <td align="right" valign="top">
            <div style="display:inline-block; text-align:right; min-width: 200px;">
              <span class="eb-badge" style="background:#F5A623; color:#1a1d2e; font-size:16px; font-weight:800; letter-spacing:1px; text-transform:uppercase; padding:6px 0; border-radius:3px; display:block; text-align:center; line-height:1; margin-bottom:8px;">New Booking</span>
