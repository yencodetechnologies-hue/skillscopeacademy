        ...
        <div className="s5-page">
            ...
            <div className="s5-card">
                ...
                <div className="s5-policy-box">
                    ...
                    <div className="s5-policy-item s5-contact-block">
                        ...
                        <p>SafeTicks — Maria Hajjar</p>
                        <p>0439 007 746</p>
                        <p>maria@safeticks.com.au</p>
                    </div>
                </div>
            </div>
            ...
            <div className="s5-card">
                ...
                <div className="s5-policy-box">
                    <div className="s5-policy-item">
                        ...
                        <p>Complaints are recorded and managed through SafeTicks' complaints process. If not resolved, you may lodge an appeal. Appeals may progress to independent mediation (e.g., National Training Complaints Hotline / Ombudsman pathways where applicable).</p>
                    </div>
                    <div className="s5-policy-item">
                        <h5>Reassessment</h5>
                        <p>If you believe an assessment outcome is unfair, first discuss with your assessor. If unresolved, follow the formal appeals process. SafeTicks may require evidence, and independent reassessment may be arranged where necessary.</p>
                    </div>
                    <div className="s5-policy-item">
                        <h5>Consumer Guarantee</h5>
                        <p>SafeTicks will provide training and assessment with due care and skill, fit for purpose, and within a reasonable timeframe.</p>
                    </div>
                    <div className="s5-policy-item">
                        <h5>Change to agreed services</h5>
                        <p>Changes may occur due to course/practical requirements, third party arrangements, or ownership changes. Where possible, SafeTicks will notify affected learners.</p>
                    </div>
                    <div className="s5-policy-item">
                    ...
                    <div className="s5-policy-item">
                        ...
                        <p>By signing this form, you confirm the information provided is correct and you agree to SafeTicks policies and procedures.</p>
                    </div>
                </div>
            </div>
            ...
            <div className="s5-card">
                ...
                <ul className="s5-declaration-list">
                    ...
                    <li>I understand SafeTicks policies apply (training, assessment, complaints/appeals and privacy).</li>
                </ul>
