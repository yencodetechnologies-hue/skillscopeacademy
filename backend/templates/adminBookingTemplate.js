const adminBookingTemplate = (data) => {
  ...
  const gatewayRow = gatewayIdValue !== '-' ? `
    <tr>
      ...
      <td class="val" style="color: #F57C00;"><strong>${gatewayIdValue}</strong></td>
    </tr>` : '';
...
<head>
  ...
  <style>
    ...
    .eb-badge { background: #F57C00; color: #1a1d2e; font-size: 10px; font-weight: 700; letter-spacing: 0.8px; text-transform: uppercase; padding: 3px 10px; border-radius: 2px; white-space: nowrap; display: inline-block; line-height: 1; }
    ...
    .eb-table td a { color: #F57C00; text-decoration: none; }

    /* ── Total row ── */
    .eb-total-row td { background: #f0f6ff !important; border-top: 2px solid #F57C00; }
        ...
        <tr>
          ...
          <td align="right" valign="top">
            <div style="display:inline-block; text-align:right; min-width: 200px;">
              <span class="eb-badge" style="background:#F57C00; color:#1a1d2e; font-size:16px; font-weight:800; letter-spacing:1px; text-transform:uppercase; padding:6px 0; border-radius:3px; display:block; text-align:center; line-height:1; margin-bottom:8px;">New Booking</span>
